...
public class RoundRobin2 implements Executable {
	...
	public Result execute(ArrayList<Process> processes) {
            ...
            float quanta = 0;
            int throughput = 0;
            System.out.println("Process ID: " + "   Turnaround Time: " + "   Arrival Time " + "   Response Time: " + "  Run Time: " +  "  Wait Time: ");
            ...
            while(currentQueue.peek() != null && quanta < 100){
                 if(currentQueue.peek() != null){
                    //changes the current burst time by subtracting from the quantum time
                     currentQueue.element().changeBurstTime(currentQueue.element().getBurstTime() - 1);
                     ...
                     if(currentQueue.peek().getBurstTime() < 0){
                         ...
                         currentQueue.peek().changeWaitingTime();
                     }
                 }
                if(currentQueue.peek() != null) {
